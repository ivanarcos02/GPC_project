    ...
    pipes.forEach(pipe => {
        ...
        if (pipe.isRotating) {
            ...
            if (pipe.top.rotation.z > pipe.top.userData.maxRotation) {
                pipe.top.userData.rotationDirection = -1; // Cambiar dirección al alcanzar el máximo
            } else if (pipe.top.rotation.z < pipe.top.userData.minRotation) {
                pipe.top.userData.rotationDirection = 1; // Cambiar dirección al alcanzar el mínimo
            }

            // Rotar la tubería inferior
        ...
        // Actualizar puntuación si el pájaro pasa una tubería
